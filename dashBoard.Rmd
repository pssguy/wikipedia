...
exclude <- c("Main_Page","404.php", "Special:Search","Special:CreateAccount","Special:Book")
...
tt <- reactive({
  ...
  # more use whena nalyzing totals  
...
req(input$topTenDate)
  ...
  print(input$topTenDate)
  print("a")
  
todayTopTen <- top_articles(start = as.Date(input$topTenDate))
  (glimpse(todayTopTen))

todayTopTen <- todayTopTen %>% 
  #mutate(date <- as.Date(date)) %>% ## if not using readr 
...
info=list(vcardImage=vcardImage,todayTopTen=todayTopTen)
return(info)
...
output$one <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[1]," ",tt()$todayTopTen$views[1]," views")
...
output$two <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[2]," ",tt()$todayTopTen$views[2]," views")
...
output$three <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[3]," ",tt()$todayTopTen$views[3]," views")
...
output$four <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[4]," ",tt()$todayTopTen$views[4]," views")
...
output$five <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[5]," ",tt()$todayTopTen$views[5]," views")
...
output$six <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[6]," ",tt()$todayTopTen$views[6]," views")
...
output$seven <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[7]," ",tt()$todayTopTen$views[7]," views")
...
output$eight <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[8]," ",tt()$todayTopTen$views[8]," views")
...
output$nine <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[9]," ",tt()$todayTopTen$views[9]," views")
...
output$ten <- renderUI({
  ...
  txt <- paste0(tt()$todayTopTen$article[10]," ",tt()$todayTopTen$views[10]," views")
